<?php
// Nạp dữ liệu trang Indochine Studio từ file riêng
include '../../../includes/data-pages/data-indochine-studio.php';

// Breadcrumb cho trang Căn hộ Studio Indochine
$breadcrumb = [
    [
        'title' => 'Căn hộ',
...
<div class="room-detail-page">
    ...
    <section class="room-hero">
        <div class="hero-image">
            <img src="<?php echo asset('img/Indochine studio apartment/indochine-studio-apartment-1.jpg'); ?>" alt="Căn hộ Studio Indochine - Aurora Hotel Plaza" loading="lazy">
            ...
            <div class="image-slider" id="deluxeSlider">
                ...
                <div class="slider-main">
                    <img id="sliderMainImage"
                         src="<?php echo asset('img/Indochine studio apartment/indochine-studio-apartment-1.jpg'); ?>"
                ...
                <div class="slider-thumbs" id="sliderThumbs">
                    <img class="thumb active" src="<?php echo asset('img/Indochine studio apartment/indochine-studio-apartment-1.jpg'); ?>" data-full="<?php echo asset('img/Indochine studio apartment/indochine-studio-apartment-1.jpg'); ?>" alt="Thumb 1" loading="lazy" decoding="async">
                    <img class="thumb" src="<?php echo asset('img/Indochine studio apartment/indochine-studio-apartment-2.jpg'); ?>" data-full="<?php echo asset('img/Indochine studio apartment/indochine-studio-apartment-2.jpg'); ?>" alt="Thumb 2" loading="lazy" decoding="async">
                    <img class="thumb" src="<?php echo asset('img/Indochine studio apartment/indochine-studio-apartment-3.jpg'); ?>" data-full="<?php echo asset('img/Indochine studio apartment/indochine-studio-apartment-3.jpg'); ?>" alt="Thumb 3" loading="lazy" decoding="async">
                    <img class="thumb" src="<?php echo asset('img/Indochine studio apartment/indochine-studio-apartment-4.jpg'); ?>" data-full="<?php echo asset('img/Indochine studio apartment/indochine-studio-apartment-4.jpg'); ?>" alt="Thumb 4" loading="lazy" decoding="async">
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="lightbox" id="imageLightbox" aria-hidden="true">
        <div class="lightbox-content">
            ...
            <img id="lightboxImage" src="<?php echo asset('img/Indochine studio apartment/indochine-studio-apartment-1.jpg'); ?>" alt="Xem ảnh lớn">
