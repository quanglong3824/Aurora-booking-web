php
<?php
// Nạp dữ liệu trang Premium Deluxe Twin từ file riêng
include '../../includes/data-pages/data-premium-deluxe-twin.php';
// Breadcrumb cho trang Phòng Premium Deluxe Twin Đôi
$breadcrumb = [
    [
        'title' => 'Phòng',
        'url' => '/pages/phong.php'
...
<div class="room-detail-page">
            ...
            <div class="image-slider" id="deluxeSlider">
                ...
                <div class="slider-main">
                    <img id="sliderMainImage"
                         src="<?php echo asset('img/premium twin/PREMIUM-DELUXE-TWIN-AURORA-1.jpg'); ?>"
                ...
                <div class="slider-thumbs" id="sliderThumbs">
                    <img class="thumb active" src="<?php echo asset('img/premium twin/PREMIUM-DELUXE-TWIN-AURORA-1.jpg'); ?>" data-full="<?php echo asset('img/premium twin/PREMIUM-DELUXE-TWIN-AURORA-1.jpg'); ?>" alt="Thumb 1" loading="lazy" decoding="async">
                    <img class="thumb" src="<?php echo asset('img/premium twin/PREMIUM-DELUXE-TWIN-AURORA-2.jpg'); ?>" data-full="<?php echo asset('img/premium twin/PREMIUM-DELUXE-TWIN-AURORA-2.jpg'); ?>" alt="Thumb 2" loading="lazy" decoding="async">
                    <img class="thumb" src="<?php echo asset('img/premium twin/PREMIUM-DELUXE-TWIN-AURORA-3.jpg'); ?>" data-full="<?php echo asset('img/premium twin/PREMIUM-DELUXE-TWIN-AURORA-3.jpg'); ?>" alt="Thumb 3" loading="lazy" decoding="async">
                    <img class="thumb" src="<?php echo asset('img/premium twin/PREMIUM-DELUXE-TWIN-AURORA-4.jpg'); ?>" data-full="<?php echo asset('img/premium twin/PREMIUM-DELUXE-TWIN-AURORA-4.jpg'); ?>" alt="Thumb 4" loading="lazy" decoding="async">
                    <img class="thumb" src="<?php echo asset('img/premium twin/PREMIUM-DELUXE-TWIN-AURORA-6.jpg'); ?>" data-full="<?php echo asset('img/premium twin/PREMIUM-DELUXE-TWIN-AURORA-6.jpg'); ?>" alt="Thumb 6" loading="lazy" decoding="async">
                    <img class="thumb" src="<?php echo asset('img/premium twin/PREMIUM-DELUXE-TWIN-AURORA-7.jpg'); ?>" data-full="<?php echo asset('img/premium twin/PREMIUM-DELUXE-TWIN-AURORA-7.jpg'); ?>" alt="Thumb 7" loading="lazy" decoding="async">
                    <img class="thumb" src="<?php echo asset('img/premium twin/PREMIUM-DELUXE-TWIN-AURORA-8.jpg'); ?>" data-full="<?php echo asset('img/premium twin/PREMIUM-DELUXE-TWIN-AURORA-8.jpg'); ?>" alt="Thumb 8" loading="lazy" decoding="async">
                    <img class="thumb" src="<?php echo asset('img/premium twin/PREMIUM-DELUXE-TWIN-AURORA-9.jpg'); ?>" data-full="<?php echo asset('img/premium twin/PREMIUM-DELUXE-TWIN-AURORA-9.jpg'); ?>" alt="Thumb 9" loading="lazy" decoding="async">
                    <img class="thumb" src="<?php echo asset('img/premium twin/PREMIUM-DELUXE-TWIN-AURORA-10.jpg'); ?>" data-full="<?php echo asset('img/premium twin/PREMIUM-DELUXE-TWIN-AURORA-10.jpg'); ?>" alt="Thumb 10" loading="lazy" decoding="async">
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="lightbox" id="imageLightbox" aria-hidden="true">
        <div class="lightbox-content">
            ...
            <img id="lightboxImage" src="<?php echo asset('img/premium twin/PREMIUM-DELUXE-TWIN-AURORA-1.jpg'); ?>" alt="Xem ảnh lớn">
